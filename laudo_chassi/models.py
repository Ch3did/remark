...
class LaudoChassi(models.Model):
    tipo_servico = models.CharField(
        max_length=25, default="Gravação de Chassi", verbose_name="Tipo do Serviço"
    )
    num_chassi = models.CharField(
        max_length=25, blank=True, verbose_name="Número do Chassi"
    )
    ...
    num_autorizacao = models.CharField(
        max_length=15, blank=True, verbose_name="Número de Autorização"
    )
