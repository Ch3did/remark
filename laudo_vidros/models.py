...
DECLARACAO_PADRAO =  "Declaramos que foi realizado o serviço de gravação com os caracteres VIS..."

class LaudoVidros(models.Model):    
  tipo_servico = models.CharField(max_length=25, default="Gravação de Vidros", verbose_name="Tipo de Serviço")
  num_original = models.CharField(max_length=25, blank=True, verbose_name="Número Original")
  ...
  foto_3 = models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, verbose_name="Foto 3") 
  descricao_foto_4 = models.CharField(max_length=20, blank=True, verbose_name="Decrição da Foto 4")
  foto_4 = models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, verbose_name="Foto 4")
  descricao_foto_5 = models.CharField(max_length=20, blank=True, verbose_name="Descrição da Foto 5")
  foto_5 = models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, verbose_name="Foto 5")  
  descricao_foto_6 = models.CharField(max_length=20, blank=True, verbose_name="Descrição da Foto 6")
  foto_6 = models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, verbose_name="Foto 6")  
  descricao_foto_7 = models.CharField(max_length=20, blank=True, verbose_name="Descrição da Foto 7")
  foto_7 = models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, verbose_name="Foto 7")  
