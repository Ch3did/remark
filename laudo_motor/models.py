...
DECLARACAO_PADRAO += "Declaramos que foi realizado o serviço de Gravação do motor com os caracteres..."

class LaudoMotor(models.Model):  
  tipo_servico = models.CharField(max_length=25, default="Gravação de Motor", verbose_name="Tipo de Serviço")
  num_motor = models.CharField(max_length=25, blank=True, verbose_name="Número do Motor")
