...
DECLARACAO_PADRAO = "Declaramos que foi realizado o serviço de fabricação/aplicação da Plaqueta de Identificação de Capacidades e Cargas..."

class LaudoPlaqueta(models.Model):  
  tipo_servico = models.CharField(max_length=25, default="Plaqueta", verbose_name="Tipo de Serviço")
  ...
  num_autorizacao = models.CharField(max_length=15, blank=True, verbose_name="Número da Autorização")
  ...
  class Meta:
    verbose_name_plural = "Laudos de Plaquetas"
